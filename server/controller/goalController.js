...
const { Goals, User } = require("../model");
...
const getAllRecords = async (req, res) => {
  try {
    ...
    const data = await readService(queryString, Goals, association);
...
const getARecord = async (req, res) => {
  try {
    ...
    const data = await readAService(id, Goals);
...
const getAuthUserRecords = async (req, res) => {
  try {
    ...
    const data = await readUserServices(userID, queryString, Goals, User);
...
const createARecord = async (req, res) => {
  try {
    ...
    const newData = await createService(data, Goals, User);
...
const updateARecord = async (req, res) => {
  try {
    ...
    const updateDate = await updateService(data, id, Goals, User);
...
const deleteARecord = async (req, res) => {
  try {
    ...
    const deleteDate = await deleteService(data, id, Goals, User);
