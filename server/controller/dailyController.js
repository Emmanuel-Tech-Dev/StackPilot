...
const { Daily, Week, User } = require("../model");
...
const getAllRecords = async (req, res) => {
  try {
    ...
    const data = await readService(queryString, Daily, association);
...
const getARecord = async (req, res) => {
  try {
    ...
    const data = await readAService(id, Daily);
...
const getAuthUserRecords = async (req, res) => {
  try {
    ...
    const data = await readUserServices(userID, queryString, Daily, User);
...
const updateARecord = async (req, res) => {
  try {
    ...
    const updateDate = await updateService(data, id, Daily, User);
...
const deleteARecord = async (req, res) => {
  try {
    ...
    const deleteDate = await deleteService(data, id, Daily, User);
