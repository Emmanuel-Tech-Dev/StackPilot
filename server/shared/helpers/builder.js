class Builder {
  ...
  select(table, fields, others) {
    if (table == undefined || table == null)
      throw "Parameter 1 of select is required";
    let f = "";
  ...
  multiSelect(table, fields, others, explicitJoin) {
    if (table == undefined || table == null)
      throw "Parameter 1 of select is required";
    if (typeof table == "object" && table.length <= 1)
      throw "For a single table, kindly use the select function";
    if (table.length != fields.length)
      throw "The number of field groups must be equal to the number of the tables";
    let f = "";
    if (fields == null || fields == "" || fields == undefined) {
      f = "*";
    }
  ...
  where(criteria, fieldValue, reloperator = "=", logoperator) {
    if (criteria == null && fieldValue == null)
      throw "Error: Criteria parameters cannot be blank";
    if (
      (fieldValue != null || fieldValue != undefined) &&
      (reloperator == undefined || reloperator == null)
    )
      throw "Relational operator is required for the where clause";
    if (
      (fieldValue != null || fieldValue != undefined) &&
      fieldValue.length > 1 &&
      (logoperator == undefined || logoperator == null)
    )
      throw "Logical operator is required for the where clause";
    let w = " WHERE ";
    if (criteria != null) {
      w += criteria;
    } else {
  ...
  overrideLoperators(logoperator) {
    let allowed = ["AND", "OR"];
    if (typeof logoperator != "object" || logoperator == undefined)
      throw "Error: An array of logical operators is required";
    if (logoperator.length != this.fieldLen - 1)
      throw "Error: Number of logical operators must be number of fields minus 1";
  ...
  overrideReloperators(reloperators) {
    ...
    if (typeof reloperators != "object" || reloperators == undefined)
      throw "Error: An array of relational operators is required";
    if (reloperators.length != this.fieldLen)
      throw "Error: Number of relational operators must be equal to number of fields";
    let pieces = this.whr.split(" ");
    let pointer = 0;
    for (let i = 0; i < pieces.length; i++) {
  ...
  join(table1, table2, field1, field2, joinType) {
    if (this.whichSelect == "simple")
      throw "Error: Please use the multiSelect method to enable join to work";
    let j = ``;
  ...
  update(table, fieldsVals) {
    if (table == undefined || table == null)
      throw "Parameter 1 of update is required";
    if (fieldsVals == undefined || fieldsVals == null)
      throw "Parameter 2 of update is required";
  ...
  delete(table) {
    if (table == undefined || table == null)
      throw "Parameter 1 of delete is required";
  ...
  insert(table, values, autoIncrement = true, others = "") {
    if (table == undefined || table == null)
      throw "Parameter 1 of insert is required";
    if (values == undefined || values == null)
      throw "Parameter 2 of insert is required";
    if (values == undefined || values == null)
      throw "Parameter 3 of insert is required";
    let pholders = [];
    if (autoIncrement) {
  ...
  insertSome(table, values, others = "") {
    ...
    if (Array.isArray(values))
      throw "Parameter 2 of insertSome expected an Object and not Array";
    let pholders = [];
    let fields = [];
  ...
  describe(table) {
    if (table == undefined || table == null)
      throw "Parameter 1 of describe is required";
